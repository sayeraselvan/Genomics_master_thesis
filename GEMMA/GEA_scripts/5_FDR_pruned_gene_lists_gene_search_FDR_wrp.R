...
setwd(paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/FDR_corrected_without_covariate_gemma_lmm/snp_to_gene/bedtools_intersect/"))
...
setwd(paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/FDR_corrected_without_covariate_gemma_lmm/snp_to_gene/gene_list_per_variable"))
