...
input_dir <- paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/without_FDR_correction_without_covariate_gemma_lmm/association_files_results_gemma")
output_dir <- paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/FDR_corrected_without_covariate_gemma_lmm/association_files_results_gemma_FDR_corrected/")
manhattan_plot_dir <- paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/FDR_corrected_without_covariate_gemma_lmm/manhattan_plots/")
significant_snp_dir <- paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/FDR_corrected_without_covariate_gemma_lmm/significant_snps_fdr_threshold/")
