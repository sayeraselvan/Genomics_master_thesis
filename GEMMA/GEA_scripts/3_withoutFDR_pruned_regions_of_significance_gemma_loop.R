...
setwd(paste0("/netscratch/dep_coupland/grp_fulgione/siva/gemma/RESULTS_GEA/", analysis_type, "/pruned/no_covariates/without_FDR_correction_without_covariate_gemma_lmm/association_files_results_gemma"))
